...
<head>
    ...
    <title>Venkitesh BS - Personal Portfolio</title>
    ...
    <link rel="stylesheet" type="text/css" href="css/animateText.css">
        ...
        <header class="header">
            <div class="tf-container">
                <div class="header-sidebar style-1">
                    <div class="box">
                        <div class="avatar">
                            <img src="images/user/avatar-2.jpeg" width="68" height="68" alt="avatar">
                        </div>
                        <div class="info">
                            <h6 class="font-4 mb_4">Venkitesh BS</h6>
                            <div class="text-label text-uppercase fw-6 text_primary-color font-3  letter-spacing-1">
                                Full Stack
                                Developer</div>
                        </div>
                    </div>
                    <ul class="nav-menu style-1 xl-hide">
                        ...
                        <li class="text-menu text_white d-none">
                            <a href="#pricing"
                                class="nav_link toggle splitting link link-no-action text-button font-3 fw-6">
                    ...
                    <div class="d-flex gap_12 align-items-center">
                        <a href="#contact" class="tf-btn style-1 animate-hover-btn sm-hide">
                            <span>
                                Hire Me
                            </span>
                        </a>
                        <a class="menu-button show-menu-mobile  d-xl-none link-no-action" data-target="#menu-2" href="#"><i
        ...
        <div class="main-content style-fullwidth section-onepage">
            ...
            <div class="tf-container w-6">
                ...
                <div class="wrap-section ">
                    <div class="row">
                        <div class="col-xl-4">
                            <div class="user-bar style-1 text-center sticky-top">
                                <div class="box-author mb_12">
                                    <div class="img-style mb_16">
                                        <img decoding="async" loading="lazy" src="images/user/avatar.png" width="314"
                                            height="314" alt="feature post">
                                    </div>
                                    <div class="info">
                                        <div class="name font-2 text_white mb_8">Venkitesh BS</div>
                                        <div
                                            class="text-label text-uppercase fw-6 text_primary-color font-3 mb_16 letter-spacing-1">
                                            Full Stack
                                            Developer</div>
                                        <a href="mailto:coolvenki1994@gmail.com"
                                            class="hover-underline-link text_white text-body-2 mb_4">coolvenki1994@gmail.com</a>
                                ...
                                <ul class="list-icon d-flex justify-content-center">
                                    <li><a href="https://www.linkedin.com/in/venki-tesh-97098b74/" class="icon-LinkedIn"></a></li>
                                    <!-- <li> <a href="#" class="icon-GitHub"></a></li> -->
                                    <li><a href="https://x.com/Therivenki" class="icon-X"></a></li>
                        ...
                        <div class="col-xl-8">
                            <!-- section-about -->
                            <div id="about" class="section-about style-1 section first-section h-100vh">
                                <div class="heading-section mb_45">
                                    ...
                                    <div class="title-border-shape">
                                        <h4 class="animationtext clip ">Hello! I'm <span
                                                class="tf-text s1 cd-words-wrapper text_primary-color">
                                                <span class="item-text is-visible">Full Stack Developer</span>
                                ...
                                <p class="text_muted-color font-3 mb_43 split-text split-lines-transform">Hello! I'm
                                    Venkitesh BS,
a Full Stack Developer with 10 years of experience in designing and building scalable web applications. My expertise spans both front-end and back-end development, including modern frameworks, APIs, databases, and cloud technologies. Driven by a passion for creating seamless user experiences, I turn complex requirements into efficient and user-friendly solutions."</p>
                                <div class="wrap-counter tf-grid-layout md-col-3">
                                    <div class="counter-item bs-light-mode">
                                        ...
                                        <p class="text-body-1 text_muted-color font-3">Years in Web  Development</p>
                                    ...
                                    <div class="counter-item bs-light-mode">
                                        <div class="counter-number h2 text_white mb_7">
                                            <div class="odometer" data-number="20">100</div>
                                            <span class="sub">+</span>
                                        </div>
                                    ...
                                    <div class="counter-item bs-light-mode">
                                        <div class="counter-number h2 text_white mb_7">
                                            <div class="odometer" data-number="15">0</div>
                            ...
                            <div id="resume" class="section-resume style-1 pb-0 spacing-4 section">
                                <div class="heading-section mb_47">
                                    ...
                                    <h3 class="text_white fw-5 split-text effect-blur-fade">Education & Experience</h3>
                                </div>
                                <div class="effect-line-hover">
                                    <div class="wrap-education-item area-effect  scrolling-effect effectTop">
                                        ...
                                        <div class="education-item">
                                            <div class="content">
                                                <h5 class="font-4 mb_4"><a href="#contact" class="link">Team Leader</a>
                                                </h5>
                                                <span class="text-body-1 font-3">FirstMatrix Solutions</span>
                                            </div>
                                    ...
                                    <div class="wrap-education-item area-effect scrolling-effect effectTop">
                                        ...
                                        <div class="education-item">
                                            <div class="content">
                                                <h5 class="font-4 mb_4"><a href="#contact" class="link">Software Engineer</a></h5>
                                                <span class="text-body-1 font-3">Box Of Tech.</span>
                                            </div>
                                            <div class="date text-caption-1 text_white font-3">
                                                2022 - 2025
                                            </div>
                                    ...
                                    <div class="wrap-education-item area-effect scrolling-effect effectTop">
                                        ...
                                        <div class="education-item">
                                            <div class="content">
                                                <h5 class="font-4 mb_4"><a href="#contact" class="link">Web Developer</a></h5>
                                                <span class="text-body-1 font-3">Kambaa incorporation.</span>
                                            </div>
                                            <div class="date text-caption-1 text_white font-3">
                                                2020 - 2022
                                            </div>
                                    ...
                                    <div class="wrap-education-item area-effect scrolling-effect effectTop">
                                        ...
                                        <div class="education-item">
                                            <div class="content">
                                                <h5 class="font-4 mb_4"><a href="#contact" class="link">B.Tech in
                                                        Information Technology</a></h5>
                                                <span class="text-body-1 font-3">Mahendra Engineering College</span>
                                            </div>
                                            <div class="date text-caption-1 text_white font-3">
                                                2012 - 2015
                                            </div>
                                    ...
                                    <div class="wrap-education-item area-effect scrolling-effect effectTop">
                                        ...
                                        <div class="education-item">
                                            <div class="content">
                                                <h5 class="font-4 mb_4"><a href="#contact" class="link">Diploma in
                                                        Information
                                                        Technolog</a></h5>
                                                <span class="text-body-1 font-3">Salem Polytechnic College</span>
                                            </div>
                                            <div class="date text-caption-1 text_white font-3">
                                                2009 - 2012
                                            </div>
                ...
                <div id="services" class="section-service section spacing-5">
                    <div class="heading-section mb_43">
                        ...
                        <h3 class="text_white fw-5  d-none split-text effect-blur-fade">AI Solutions That Matter</h3>
                    </div>
                    <div class="service-item area-effect scrolling-effect effectBottom">
                        <div class="content-inner d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center content">
                                ...
                                <h5 class="text_white font-4"><a href="#contact" class="link">Full Stack Web Development</a>
                                </h5>
                            </div>
                    ...
                    <div class="service-item area-effect scrolling-effect effectBottom">
                        <div class="content-inner d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center content">
                                ...
                                <h5 class="text_white font-4"><a href="#contact" class="link">Frontend Development</a>
                                </h5>
                            </div>
                            <a href="#contact" class="btn-arrow"><i class="icon-ArrowRight"></i></a>
                            <div class="item-shape spotlight">
                    ...
                    <div class="service-item area-effect scrolling-effect effectBottom">
                        <div class="content-inner d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center content">
                                ...
                                <h5 class="text_white font-4"><a href="#contact" class="link">Backend Development</a>
                                </h5>
                            </div>
                            <a href="#contact" class="btn-arrow"><i class="icon-ArrowRight"></i></a>
                            <div class="item-shape spotlight">
                    ...
                    <div class="service-item area-effect scrolling-effect effectBottom">
                        <div class="content-inner d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center content">
                                ...
                                <h5 class="text_white font-4"><a href="#contact" class="link">API Development & Integration</a></h5>
                            </div>
                            <a href="#contact" class="btn-arrow"><i class="icon-ArrowRight"></i></a>
                            <div class="item-shape spotlight">
                                <img src="images/item/small-comet.webp" loading="lazy" decoding="async" alt="item">
					...
					<div class="service-item area-effect scrolling-effect effectBottom">
                        <div class="content-inner d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center content">
                                <span class="number text-label text_muted-color font-3">05/</span>
                                <h5 class="text_white font-4"><a href="#contact" class="link">Database Design & Management</a></h5>
                            </div>
                            <a href="#contact" class="btn-arrow"><i class="icon-ArrowRight"></i></a>
                            <div class="item-shape spotlight">
                                <img src="images/item/small-comet.webp" loading="lazy" decoding="async" alt="item">
                ...
                <div id="portfolio" class="section-portfolio style-1 spacing-5 section">
                    ...
                    <div class="tabs-content-wrap tf-grid-layout xl-col-2">
                        <div class="portfolio-item">
                            <a href="images/user/portfolio-item-1-1.png" data-fancybox="gallery" class="img-style">
                                <img decoding="async" loading="lazy" src="images/user/portfolio-item-1-1.png"
                                    srcset="images/user/portfolio-item-1-1.png 582w"
                                    sizes="(max-width: 582px) 100vw, 582px" width="582" height="388" alt="portfolio">
                                <div class="tag font-3 text-label text-uppercase fw-6 letter-spacing-1 d-none">
                                    Conversational AI
                                </div>
                            </a>
                            <h5 class=" title font-4 text_white"><a href="https://indianroofings.com/" class="link">Indian Roofings</a>
                            </h5>
                            <div class="item-shape">
                                <img src="images/item/small-comet.webp" loading="lazy" decoding="async" alt="item">
                            </div>
                        ...
                        <div class="portfolio-item">
                            <a href="images/user/portfolio-item-3-1.png" data-fancybox="gallery" class="img-style">
                                <img decoding="async" loading="lazy" src="images/user/portfolio-item-3-1.png"
                                    srcset="images/user/portfolio-item-3-1.png 582w"
                                    sizes="(max-width: 582px) 100vw, 582px" width="582" height="388" alt="portfolio">
                                <div class="tag font-3 text-label text-uppercase fw-6 letter-spacing-1 d-none">
                                    Predictive Analytics
                                </div>
                            </a>
                            <h5 class=" title font-4 text_white"> <a href="https://freedompestcontrol.in/" class="link">Freedom pest control service</a>
                            </h5>
                            <div class="item-shape">
                                <img src="images/item/small-comet.webp" loading="lazy" decoding="async" alt="item">
                            </div>
                        ...
                        <div class="portfolio-item">
                            <a href="images/user/portfolio-item-2-1.png" data-fancybox="gallery" class="img-style">
                                <img decoding="async" loading="lazy" src="images/user/portfolio-item-2-1.png"
                                    srcset="images/user/portfolio-item-2-1.png 582w"
                                    sizes="(max-width: 582px) 100vw, 582px" width="582" height="388" alt="portfolio">
                                <div class="tag font-3 text-label text-uppercase fw-6 letter-spacing-1">
                                    Computer Vision
                                </div>
                            </a>
                            <h5 class=" title font-4 text_white"> <a href="https://srikrenterprisesadmin.clavistech.in/" class="link">E-Bikes</a></h5>
                            <div class="item-shape">
                                <img src="images/item/small-comet.webp" loading="lazy" decoding="async" alt="item">
                            </div>
                        </div>
                        <div class="portfolio-item">
                            <a href="images/user/portfolio-item-4-1.png" data-fancybox="gallery" class="img-style">
                                <img decoding="async" loading="lazy" src="images/user/portfolio-item-4-1.png"
                                    srcset="images/user/portfolio-item-4-1.png 582w"
                                    sizes="(max-width: 582px) 100vw, 582px" width="582" height="388" alt="portfolio">
                                <div class="tag font-3 text-label text-uppercase fw-6 letter-spacing-1 d-none">
                                    Resume Pro
                                </div>
                            </a>
                            <h5 class=" title font-4 text_white"> <a href="https://smartmobiles-reactjs.idxfpm.easypanel.host/" class="link">Smart Mobiles</a>
                            </h5>
                            <div class="item-shape">
                                <img src="images/item/small-comet.webp" loading="lazy" decoding="async" alt="item">
                            </div>
                         ...
                         <div class="portfolio-item">
                            <a href="images/user/portfolio-item-4-16.png" data-fancybox="gallery" class="img-style">
                                <img decoding="async" loading="lazy" src="images/user/portfolio-item-4-16.png"
                                    srcset="images/user/portfolio-item-4-16.png 582w"
                                    sizes="(max-width: 582px) 100vw, 582px" width="582" height="388" alt="portfolio">
                                <div class="tag font-3 text-label text-uppercase fw-6 letter-spacing-1">
                                    Resume Pro
                                </div>
                            </a>
                            <h5 class=" title font-4 text_white"> <a href="https://oviya-tex.fmsbilling.in.net/public/login" class="link">Oviya Tex</a>
                            </h5>
                            <div class="item-shape">
                                <img src="images/item/small-comet.webp" loading="lazy" decoding="async" alt="item">
                            </div>
                         ...
                         <div class="portfolio-item">
                            <a href="images/user/portfolio-item-4-17.png" data-fancybox="gallery" class="img-style">
                                <img decoding="async" loading="lazy" src="images/user/portfolio-item-4-17.png"
                                    srcset="images/user/portfolio-item-4-17.png 582w"
                                    sizes="(max-width: 582px) 100vw, 582px" width="582" height="388" alt="portfolio">
                                <div class="tag font-3 text-label text-uppercase fw-6 letter-spacing-1">
                                    Resume Pro
                                </div>
                            </a>
                            <h5 class=" title font-4 text_white"> <a href="https://kannanjewellery.in/" class="link">Kannan Jewellery</a>
                            </h5>
                            <div class="item-shape">
                                <img src="images/item/small-comet.webp" loading="lazy" decoding="async" alt="item">
                            </div>
                ...
                <!-- section-testimonial-->
                <div id="testimonial" class="section-testimonial d-none style-1 section spacing-5 sw-layout">
                ...
                <!-- section-pricing-->
                <div id="pricing" class="section-pricing d-none flat-animate-tab spacing-5 section">
                    <div class="heading-section mb_42">
                        <div class="tag-heading text-uppercase text-label font-3 letter-spacing-1 mb_30">
                            Pricing
                        </div>
                ...
                <!-- section-partner-->
                <div id="partners" class="section-partner d-none style-2 section spacing-5">
                    <div class="row">
                        <div class="col-xl-5">
                ...
                <div id="contact" class="section-contact style-1 section spacing-6">
                                ...
                                <div class="heading-title">
                                    <div class="mb_12">
                                        <h4 class="text_white fw-4 mb_4"><a href="#"
                                                class="hover-underline-link link">coolvenki1994@gmail.com</a></h4>
                                        <!-- <p class="text-caption-2 text_secondary-color font-3">Based in San Francisco, CA -->
                                        </p>
                                    </div>
                        ...
                        <div class="col-xl-7">
                            <form class="form-contact bs-light-mode">
                                <div class="d-grid gap_24  mb_24">
                                    ...
                                    <fieldset>
                                        <textarea id="message" class="" rows="4" placeholder="Your Message..."
                                            tabindex="2" aria-required="true" required=""></textarea>
                                    </fieldset>
                                </div>

                                <ul class="list-tag d-none">
                    ...
                    <p class="font-3 text_secondary-color text-center">© 2025 VenkiteshBS. All Rights Reserved.</p>
                </div>
                <!-- End section-contact -->
            ...
            <div class="right-bar style-1 d-flex flex-column align-items-center">
                <ul class="list-icon menu-option d-flex flex-column gap_8">
                    ...
                    <li><a class="d-none" data-bs-toggle="offcanvas" href="#setting-menu" role="button" aria-controls="setting-menu"><i
    ...
    <div class="offcanvas offcanvas-bottom popup-setting" id="setting-menu">
        <div class="close-menu" data-bs-dismiss="offcanvas">
            <i class="icon icon-times-solid"></i>
        </div>
        <div class="offcanvas-body ">
            <div class="mb-body">
                <div class="inner">
                    <div class="setting-color-option">
                        <div class="wrap-features">
                            <div class="feature-color tf-setting-color ">
                                <h5 class="font-4 mb_29">Color</h5>
                                <div class="settings-color list-choose"><a href="#;"
                                        class="choose-item link-no-action active"></a>
                                    <a href="#;" class="choose-item link-no-action"></a>
                                    <a href="#;" class="choose-item link-no-action"></a>
                                    <a href="#;" class="choose-item link-no-action"></a>
                                    <a href="#;" class="choose-item link-no-action"></a>
                                    <a href="#;" class="choose-item link-no-action"></a>
                            ...
                            <div class="features-background ">
                                <h5 class="font-4 mb_19">Background</h5>
                                <div class="d-flex flex-wrap wrap-feature-bg-item">
                                    <div class="feature-bg-item">
                                        <img src="images/landing/feature-bg-1.webp" width="207" height="76"
                                            loading="lazy" decoding="async"
                                            srcset="images/landing/feature-bg-1.webp 207w"
                                            sizes="(max-width: 207px) 100vw, 207px" alt="feature-bg">
                                        <a href="home-v1.html" target="_blank"
                                            class="text-body-1 text_white font-3">Glowing
                                            Digital
                                            Waves</a>
                                    </div>
                                    <div class="feature-bg-item">
                                        <img src="images/landing/feature-bg-2.webp" width="207" height="76"
                                            loading="lazy" decoding="async"
                                            srcset="images/landing/feature-bg-2.webp 207w"
                                            sizes="(max-width: 207px) 100vw, 207px" alt="feature-bg">
                                        <a href="home-v2.html" target="_blank"
                                            class="text-body-1 text_white font-3">Vibrant
                                            Particle Glow</a>
                                    </div>
                                    <div class="feature-bg-item">
                                        <img src="images/landing/feature-bg-3.webp" width="207" height="76"
                                            loading="lazy" decoding="async"
                                            srcset="images/landing/feature-bg-3.webp 207w"
                                            sizes="(max-width: 207px) 100vw, 207px" alt="feature-bg">
                                        <a href="home-v3.html" target="_blank"
                                            class="text-body-1 text_white font-3">Cyber
                                            Particle
                                            Waves</a>
                                    </div>
                                    <div class="feature-bg-item">
                                        <img src="images/landing/feature-bg-4.webp" width="207" height="76"
                                            loading="lazy" decoding="async"
                                            srcset="images/landing/feature-bg-4.webp 207w"
                                            sizes="(max-width: 207px) 100vw, 207px" alt="feature-bg">
                                        <a href="home-v4.html" target="_blank"
                                            class="text-body-1 text_white font-3">Slow-Motion
                                            Particle Wave</a>
                                    </div>
                                    <div class="feature-bg-item">
                                        <img src="images/landing/feature-bg-7.webp" width="207" height="76"
                                            loading="lazy" decoding="async"
                                            srcset="images/landing/feature-bg-7.webp 207w"
                                            sizes="(max-width: 207px) 100vw, 207px" alt="feature-bg">
                                        <a href="home-v7.html" target="_blank"
                                            class="text-body-1 text_white font-3">Futuristic
                                            Cyber Matrix</a>
                                    </div>
                                    <div class="feature-bg-item">
                                        <img src="images/landing/feature-bg-5.webp" width="207" height="76"
                                            loading="lazy" decoding="async"
                                            srcset="images/landing/feature-bg-5.webp 207w"
                                            sizes="(max-width: 207px) 100vw, 207px" alt="feature-bg">
                                        <a href="home-v5.html" target="_blank"
                                            class="text-body-1 text_white font-3">Particle
                                            Wave
                                            Form</a>
                                    </div>
                                    <div class="feature-bg-item">
                                        <img src="images/landing/feature-bg-6.webp" width="207" height="76"
                                            loading="lazy" decoding="async"
                                            srcset="images/landing/feature-bg-6.webp 207w"
                                            sizes="(max-width: 207px) 100vw, 207px" alt="feature-bg">
                                        <a href="home-v6.html" target="_blank"
                                            class="text-body-1 text_white font-3">Looping
                                            Particle Animation</a>
                                    </div>
                                    <div class="feature-bg-item">
                                        <img src="images/landing/feature-bg-8.webp" width="207" height="76"
                                            loading="lazy" decoding="async"
                                            srcset="images/landing/feature-bg-8.webp 207w"
                                            sizes="(max-width: 207px) 100vw, 207px" alt="feature-bg">
                                        <a href="home-v8.html" target="_blank"
                                            class="text-body-1 text_white font-3">Seamless
                                            Particle Glow</a>
                                    </div>
                                    <div class="feature-bg-item">
                                        <img src="images/landing/feature-bg-9.webp" width="207" height="76"
                                            loading="lazy" decoding="async"
                                            srcset="images/landing/feature-bg-9.webp 207w"
                                            sizes="(max-width: 207px) 100vw, 207px" alt="feature-bg">
                                        <a href="home-v9.html" target="_blank"
                                            class="text-body-1 text_white font-3">Digital
                                            technology</a>
                                    </div>
                                    <div class="feature-bg-item">
                                        <img src="images/landing/feature-bg-11.webp" width="207" height="76"
                                            loading="lazy" decoding="async"
                                            srcset="images/landing/feature-bg-11.webp 207w"
                                            sizes="(max-width: 207px) 100vw, 207px" alt="feature-bg">
                                        <a href="home-v10.html" target="_blank"
                                            class="text-body-1 text_white font-3">Dotted
                                            waves
                                            bounce</a>
                                    </div>
                                    <div class="feature-bg-item">
                                        <img src="images/landing/feature-bg-10.webp" width="207" height="76"
                                            loading="lazy" decoding="async"
                                            srcset="images/landing/feature-bg-10.webp 207w"
                                            sizes="(max-width: 207px) 100vw, 207px" alt="feature-bg">
                                        <a href="home-v11.html" target="_blank"
                                            class="text-body-1 text_white font-3">Solid
                                            Color
                                            Background</a>
                                    </div>
                                </div>
    ...
    <script src="js/handleGsap.js"></script>
...
<!-- Mirrored from zen-g-seven.vercel.app/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Mar 2026 12:24:41 GMT -->
</html>